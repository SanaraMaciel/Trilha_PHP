                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="<?= base_url('/admin')?>">Ínicio</a></li>                        
                                <li><a href="<?= base_url('admin/receitas/receitas_ver') ?>">Receitas</a></li>
                                <li><a href="<?= base_url('admin/contato') ?>">Contato</a></li>
